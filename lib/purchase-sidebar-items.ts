...
import { FileText, ShoppingCart, Truck, Package, CheckCircle, ArrowLeftRight } from "lucide-react"
...
export const createPurchaseSidebarItems = (t: (key: TranslationKey) => string) => [
  ...
  { title: t('transferOrder'), href: "/purchase/transfer-orders", icon: React.createElement(ArrowLeftRight, { className: "h-4 w-4" }) },
