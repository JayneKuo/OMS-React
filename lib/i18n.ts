...
export const translations = {
  zh: {
    ...
    // ==================== Client Portal - Sales Orders ====================
    cpSalesOrders: '销售订单',
    cpAllChannels: '全渠道 — Amazon, Walmart, Shopify, TikTok, Shein',
    cpFilterOrderNo: '订单号',
    cpFilterChannelOrderNo: '渠道单号',
    cpFilterRefOrderNo: '关联单号',
    cpFilterCustomer: '客户',
    cpFilterChannel: '渠道',
    cpFilterCreatedDate: '创建日期',
    cpFilterIssueType: '问题类型',
    cpIssueImportError: '导入错误',
    cpIssueOverdue: '发货逾期',
    cpIssueSyncFail: 'ASN回传失败',
    cpIssueDcRejected: 'DC拒收',
    cpIssueSlaRisk: 'SLA风险',
    cpIssueAllocFailed: '库存不足',
    cpIssueOnHold: '暂停中',
    cpIssueException: '异常',
    cpFilterBatchPlaceholderOrder: '输入订单号，支持逗号、空格或换行分隔...',
    cpFilterBatchPlaceholderChannel: '输入渠道单号，支持逗号、空格或换行分隔...',
    cpFilterBatchPlaceholderRef: '输入关联单号，支持逗号、空格或换行分隔...',
    cpFilterToday: '今天',
    cpFilterYesterday: '昨天',
    cpFilterLast7Days: '最近7天',
    cpFilterLast30Days: '最近30天',
    cpFilterLast90Days: '最近90天',
    cpSearchPlaceholder: '搜索订单号、PO号、渠道单号、客户...',
    cpActiveFilters: '已选筛选:',
    cpClearAll: '清除全部',
    cpFilteredByAlert: '按告警筛选中',
    cpOrdersCount: '订单',
    cpPending: '待处理',
    // Stats Cards
    cpTodayFulfillment: '今日履约',
    cpShippingOnTime: '发货准时率',
    cpOnTimeRate: '准时率',
    cpTodayDue: '今日应发',
    cpShippedLabel: '已发',
    cpOverdueNow: '当前逾期',
    cpHideOverview: '隐藏概览',
    cpShowOverview: '显示概览',
    cpRemainingToShip: '剩余待发',
    cpNoShipmentsDueToday: '今日无需发货',
    cpAllClear: '全部完成',
    cpOrderVolume: '订单量',
    cpOrdersUnit: '单',
    cpToday: '今日',
    cpUnits: '件',
    cpAvgFulfillment: '平均履约',
    cpDays: '天',
    cpOrderToShip: '下单到发货',
    cpShippedOrders: '已发货订单',
    cpInventoryRisk: '库存风险',
    cpSkusShort: '个SKU缺货',
    cpOrdersBlocked: '订单受阻',
    cpOrdersBlockedShort: '单受阻',
    cpReallocate: '调拨',
    cpContactWh: '联系仓库',
    cpFix: '修复',
    cpReview: '查看',
    ...
    cpStalled: '停滞',
    cpHealthy: '正常',
    cpNoStockIssues: '未检测到库存问题',
    cpExFulfillmentHealth: '履约健康度',
    cpExRevenueAtRisk: '风险营收',
    cpNoRevenueBlocked: '无营收受阻',
    cpOpTasks: '待处理',
    cpViewExecutive: '管理视图',
    cpViewOperational: '运营视图',
    // Alert labels
    cpAlertImportError: '导入错误',
    cpAlertImportErrorDesc: '订单数据问题 — 缺少SKU、地址无效或API格式错误。修复数据后重新导入。',
    cpAlertOverdue: '逾期',
    cpAlertOverdueDesc: '已超过发货日期 — 罚款累积中。{value}面临风险。请联系仓库今日发货。',
    cpAlertAsnFailed: 'ASN失败',
    cpAlertAsnFailedDesc: '已发货但零售商未收到确认。立即重新提交ASN以避免扣款。',
    cpAlertDcRejected: 'DC拒收',
    cpAlertDcRejectedDesc: '零售商拒绝收货 — 需重新贴标并重发。{value}被阻。',
    cpAlertSla: 'SLA',
    cpAlertSlaDesc: '平台截止时间临近 — 优先处理这些订单，否则将面临延迟发货罚款。',
    cpAlertWhStalled: '仓库停滞',
    cpAlertWhStalledDesc: '出库单在仓库卡住（拣货/打包中）。联系仓库加急处理。',
    cpAlertPartialShip: '部分发货',
    cpAlertPartialShipDesc: '部分货物已发出，其余卡在仓库。剩余商品可能错过交付窗口。',
    cpAlertUnprocessed: '未处理',
    cpAlertUnprocessedDesc: '导入超过24小时，尚未分配库存。分配库存以开始履约。',
    // Status tabs
    cpStatusAll: '全部',
    cpStatusNeedsAction: '待处理',
    cpStatusImported: '已导入',
    cpStatusOnHold: '暂停',
    cpStatusAllocated: '已分配',
    cpStatusWarehouseProcessing: '仓库处理中',
    cpStatusShipped: '已发货',
    cpStatusDeallocated: '已取消分配',
    cpStatusCancelled: '已取消',
    cpStatusException: '异常',
    // Table headers
    cpColChannel: '渠道',
    cpColOrderNo: '订单号',
    cpColChannelOrderNo: '渠道单号',
    cpColCustomer: '客户',
    cpColShipTo: '收货地',
    cpColSkuQty: 'SKU/数量',
    cpColAmount: '金额',
    cpColStatus: '状态',
    cpColShipWindow: '发货窗口',
    cpColShipments: '发货单',
    cpColPoNo: 'PO号',
    cpColShipBySla: '发货截止/SLA',
    cpColFulfillment: '履约',
    cpColSkuUnits: 'SKU/件数',
    cpColCreated: '创建时间',
    cpColActions: '操作',
    cpColIssueNote: '问题/备注',
    cpColWarehouse: '仓库',
    cpColShipFrom: '发货地',
    cpColShipDate: '发货日期',
    cpColUnits: '件数',
    cpColPallets: '托盘',
    cpColTrackingDocs: '物流/单据',
    cpColLotSn: '批次/序列号',
    cpColObOrderNo: '出库单号',
    // Expanded row
    cpDeliverBy: '交付截止:',
    ...
    cpUnitsLabel: '件',
    cpNote: '备注:',
    cpImportErrorLabel: '导入错误:',
    cpNoOutboundOrders: '尚未创建出库单',
    cpFixAndRetryImport: '订单数据有问题 — 修复后重新导入',
    cpRef: '关联:',
    cpVia: '来自',
    cpDcRcvd: 'DC已收',
    // Row actions
    cpFixRetry: '修复并重试',
    cpResubmitAsn: '重新提交ASN',
    cpRelabelReship: '重新贴标发货',
    cpRetryAllocation: '重试分配',
    cpRelease: '释放',
    cpRetryPush: '重试推送',
    cpShipNow: '立即发货',
    // Empty state
    cpNoOrdersFound: '未找到订单',
    // Status labels
    cpStatusImportedLabel: '已导入',
    cpStatusOnHoldLabel: '暂停',
    cpStatusAllocatedLabel: '已分配',
    cpStatusDeallocatedLabel: '已取消分配',
    cpStatusWarehouseProcessingLabel: '仓库处理中',
    cpStatusShippedLabel: '已发货',
    cpStatusCancelledLabel: '已取消',
    cpStatusExceptionLabel: '异常',
    // Alert bar
    cpIssues: '个问题',
    cpImmediateAction: '立即处理',
    cpFollowUp: '尽快跟进',
    cpMonitor: '需要关注',
    cpMore: '更多',
    // Misc
    ...
    cpShipmentPicking: '拣货中',
    cpShipmentPacked: '已打包',
    cpShipmentShipped: '已发货',
    cpShipmentInTransit: '运输中',
    cpShipmentDcConfirmed: 'DC已确认',
    cpShipmentDcRejected: 'DC已拒收',
    // Tag labels
    cpTagOverdue: '逾期',
    cpTagSyncFail: '同步失败',
    cpTagDcRejected: 'DC拒收',
    cpTagDcShort: 'DC短缺',
    cpTagUrgent: '紧急',
    cpTagSlaRisk: 'SLA风险',
    cpTagWhStalled: '仓库停滞',
    cpTagAllocFailed: '分配失败',
    cpTagPartialShip: '部分发货',
    cpTagImportError: '导入错误',
    // Mapping center
    mappingPageTitle: 'Mapping Center',
    mappingPageDescription: '以 OMS Product 为中心管理 channel SKU 与 warehouse SKU 的履约映射。',
    mappingHeaderCount: 'OMS Products',
    mappingCreate: '新建 Mapping',
    mappingCenterTitle: 'OMS Product Mappings',
    mappingCenterDescription: '一个 OMS Product 可绑定多个渠道 SKU，但只允许绑定一个仓库 SKU。',
    mappingSearchPlaceholder: '搜索 OMS Product、channel SKU、warehouse SKU...',
    mappingFilterChannel: '渠道',
    mappingFilterWarehouse: '仓库',
    mappingSummaryTotal: 'OMS Products',
    mappingSummaryTotalDesc: '当前原型中的商品映射聚合数。',
    mappingSummaryComplete: 'Complete',
    mappingSummaryCompleteDesc: '已同时完成 channel 与 warehouse 映射。',
    mappingSummaryPartial: 'Partial',
    mappingSummaryPartialDesc: '仅完成单侧映射，仍需补全。',
    mappingSummaryInvalid: 'Invalid',
    mappingSummaryInvalidDesc: '存在冲突、重复或缺失必填项。',
    mappingStatusComplete: 'Complete',
    mappingStatusPartial: 'Partial',
    mappingStatusUnmapped: 'Unmapped',
    mappingStatusInvalid: 'Invalid',
    mappingTableProduct: 'OMS Product',
    mappingTableProductName: 'Product Name',
    mappingTableChannelCount: 'Channel Mappings',
    mappingTableWarehouse: 'Warehouse Mapping',
    mappingTableStatus: 'Status',
    mappingTableUpdated: 'Updated',
    mappingTableChannelRows: 'channel rows',
    mappingEmptyTitle: '未找到 Mapping',
    mappingEmptyDescription: '请调整筛选条件，或新建一个 OMS Product Mapping。',
    mappingDrawerTitle: 'OMS Product Mapping Detail',
    mappingDrawerDescription: '在一个详情面板中管理多个渠道 SKU 与唯一仓库 SKU。',
    mappingSectionProduct: 'OMS Product',
    mappingSectionProductDesc: '选择本次要管理的 OMS 商品中心对象。',
    mappingSelectOmsProduct: '选择 OMS Product',
    mappingOmsProductCode: 'OMS Product Code',
    mappingOmsProductName: 'OMS Product Name',
    mappingSectionChannels: 'Channel Mappings',
    mappingSectionChannelsDesc: '一个 OMS Product 可维护多条渠道 SKU 映射。',
    mappingAddChannel: '添加渠道映射',
    mappingChannelsEmpty: '当前还没有渠道 SKU 映射。',
    mappingChannelRow: '渠道映射',
    mappingChannel: '渠道',
    mappingStore: '店铺',
    mappingChannelSku: '渠道 SKU',
    mappingChannelEnabled: '启用此渠道映射',
    mappingChannelEnabledDesc: '关闭后保留记录，但不参与履约识别。',
    mappingSectionWarehouse: 'Warehouse Mappings',
    mappingSectionWarehouseDesc: '一个 OMS Product 可配置多个仓库 SKU 映射，对应不同仓储服务商。',
    mappingSelectWarehouseTarget: '选择仓库 SKU',
    mappingWarehouseEmpty: '当前未配置 warehouse mapping。',
    mappingWarehouseRow: '仓库映射',
    mappingAddWarehouse: '添加仓库映射',
    mappingWarehouse: '仓库',
    mappingWarehouseSku: 'Warehouse SKU',
    mappingItemCode: 'Item Code',
    mappingItemMasterId: 'Item Master ID',
    mappingItemName: 'Item Name',
    mappingWarehouseEnabled: '启用仓库映射',
    mappingWarehouseEnabledDesc: '关闭后商品保留绑定信息，但不作为履约目标。',
    mappingChannelSkuHint: '输入 SKU，回车或逗号确认，支持多个',
    mappingStoreSearch: '搜索店铺...',
    mappingStoreEmpty: '无匹配店铺，可输入自定义',
    mappingNotesDesc: '记录该映射存在的原因或切换说明。',
    mappingValidationTitle: '校验结果',
    mappingValidationNoIssues: '当前没有发现冲突。',
    mappingSave: '保存 Mapping',
    mappingIssueProductCodeRequired: 'OMS Product Code 为必填项。',
    mappingIssueProductNameRequired: 'OMS Product Name 为必填项。',
    mappingIssueOmsProductAssigned: '该 OMS Product 已经存在映射聚合，请改为编辑现有记录。',
    mappingIssueChannelRequired: '每条 channel mapping 都必须填写 channel、store 和至少一个 channel SKU。',
    mappingIssueDuplicateChannelInProduct: '同一个 OMS Product 内不能重复添加相同的 channel SKU。',
    mappingIssueChannelAssignedElsewhere: '该 channel SKU 已经归属于其他 OMS Product。',
    mappingIssueWarehouseRequired: '如配置 warehouse mapping，则 warehouse 与 warehouse SKU 必填。',
    mappingIssueDuplicateWarehouseInProduct: '同一个 OMS Product 内不能配置相同仓库的多条映射。',
    mappingImport: '批量导入',
    mappingImportTitle: '批量导入 Mapping',
    mappingImportDescription: '上传 CSV 文件批量创建或更新 OMS Product Mapping。',
    mappingImportDownloadTemplate: '下载 CSV 模板',
    mappingImportUpload: '上传 CSV 文件',
    mappingImportPreviewTitle: '导入预览',
    mappingImportPreviewRows: '行记录',
    mappingImportConfirm: '确认导入',
    mappingImportSuccess: '导入成功',
    mappingImportErrorParse: '文件解析失败，请检查格式是否正确。',
    mappingImportColProduct: 'OMS Product Code',
    mappingImportColChannel: 'Channel',
    mappingImportColStore: 'Store',
    mappingImportColChannelSku: 'Channel SKU',
    mappingImportColWarehouse: 'Warehouse',
    mappingImportColWarehouseSku: 'Warehouse SKU',
    mappingHistoryTitle: '变更记录',
    mappingHistoryEmpty: '暂无变更记录。',
    mappingHistoryActionCreated: '创建',
    mappingHistoryActionUpdated: '更新',
    mappingHistoryBy: '操作人',
    mappingAutoMatchTitle: '自动 Mapping',
    mappingAutoMatchDescription: '根据 OMS Product 名称向下游仓库目录自动匹配，仅补全仓库侧映射，渠道侧 SKU 需手动配置。',
    mappingAutoMatchRun: '运行自动匹配',
    mappingAutoMatchApply: '应用 {count} 条匹配',
    mappingAutoMatchNoResult: '未找到可自动匹配的仓库 SKU。',
    mappingAutoMatchNewWarehouse: '将新增仓库映射',
    mappingAutoMatchAlreadyMapped: '已有仓库映射，跳过',
    mappingAutoMatchSelectAll: '全选',
    mappingAutoMatchSuccess: '已成功应用 {count} 条自动匹配。',
  },
  en: {
    // ==================== Common ====================
    actions: 'Actions',
    ...
    // ==================== Client Portal - Sales Orders ====================
    cpSalesOrders: 'Sales Orders',
    cpAllChannels: 'All channels — Amazon, Walmart, Shopify, TikTok, Shein',
    cpFilterOrderNo: 'Order #',
    cpFilterChannelOrderNo: 'Channel Order #',
    cpFilterRefOrderNo: 'Ref Order #',
    cpFilterCustomer: 'Customer',
    cpFilterChannel: 'Channel',
    cpFilterCreatedDate: 'Created Date',
    cpFilterIssueType: 'Issue Type',
    cpIssueImportError: 'Import Error',
    cpIssueOverdue: 'Overdue',
    cpIssueSyncFail: 'ASN Failed',
    cpIssueDcRejected: 'DC Rejected',
    cpIssueSlaRisk: 'SLA Risk',
    cpIssueAllocFailed: 'Allocation Failed',
    cpIssueOnHold: 'On Hold',
    cpIssueException: 'Exception',
    cpFilterBatchPlaceholderOrder: 'Enter order numbers, separated by comma, space or newline...',
    cpFilterBatchPlaceholderChannel: 'Enter channel order numbers, separated by comma, space or newline...',
    cpFilterBatchPlaceholderRef: 'Enter reference order numbers, separated by comma, space or newline...',
    cpFilterToday: 'Today',
    cpFilterYesterday: 'Yesterday',
    cpFilterLast7Days: 'Last 7 Days',
    cpFilterLast30Days: 'Last 30 Days',
    cpFilterLast90Days: 'Last 90 Days',
    cpSearchPlaceholder: 'Search order #, PO #, channel order #, customer...',
    cpActiveFilters: 'Active filters:',
    cpClearAll: 'Clear all',
    cpFilteredByAlert: 'Filtered by alert',
    cpOrdersCount: 'orders',
    cpPending: 'pending',
    // Stats Cards
    cpTodayFulfillment: "Today's Fulfillment",
    cpShippingOnTime: 'Shipping On Time',
    cpOnTimeRate: 'on-time',
    cpTodayDue: 'Due today',
    cpShippedLabel: 'shipped',
    cpOverdueNow: 'overdue now',
    cpHideOverview: 'Hide overview',
    cpShowOverview: 'Show overview',
    cpRemainingToShip: 'remaining to ship',
    cpNoShipmentsDueToday: 'No shipments due today',
    cpAllClear: 'All clear',
    cpOrderVolume: 'Order Volume',
    cpOrdersUnit: 'orders',
    cpToday: 'today',
    cpUnits: 'units',
    cpAvgFulfillment: 'Avg Fulfillment',
    cpDays: 'days',
    cpOrderToShip: 'Order to ship',
    cpShippedOrders: 'shipped orders',
    cpInventoryRisk: 'Inventory Risk',
    cpSkusShort: 'SKUs short',
    cpOrdersBlocked: 'orders blocked',
    cpOrdersBlockedShort: 'orders blocked',
    cpReallocate: 'Reallocate',
    cpContactWh: 'Contact WH',
    cpFix: 'Fix',
    cpReview: 'Review',
    cpViewAll: 'View all',
    cpShowLess: 'Show less',
    cpMoreSkus: 'more SKUs',
    cpStalled: 'stalled',
    cpHealthy: 'Healthy',
    cpNoStockIssues: 'No stock issues detected',
    cpExFulfillmentHealth: 'Fulfillment Health',
    cpExRevenueAtRisk: 'Revenue at Risk',
    cpNoRevenueBlocked: 'No revenue blocked',
    cpOpTasks: 'Tasks',
    cpViewExecutive: 'Executive',
    cpViewOperational: 'Operational',
    // Alert labels
    cpAlertImportError: 'Import Error',
    cpAlertImportErrorDesc: 'Order data issues — missing SKU, invalid address, or API format error. Fix data and re-import.',
    cpAlertOverdue: 'Overdue',
    cpAlertOverdueDesc: 'Past ship date — penalties accruing. {value} at risk. Contact warehouse to ship today.',
    cpAlertAsnFailed: 'ASN Failed',
    cpAlertAsnFailedDesc: 'Shipped but retailer has no confirmation. Resubmit ASN now to avoid chargebacks.',
    cpAlertDcRejected: 'DC Rejected',
    cpAlertDcRejectedDesc: 'Retailer refused delivery — relabel and reship. {value} blocked.',
    cpAlertSla: 'SLA',
    cpAlertSlaDesc: 'Platform deadline approaching — prioritize these or face late-ship penalties.',
    cpAlertWhStalled: 'WH Stalled',
    cpAlertWhStalledDesc: 'Outbound order stuck at warehouse (picking/packing). Contact warehouse to expedite.',
    cpAlertPartialShip: 'Partial Ship',
    cpAlertPartialShipDesc: 'Some shipments sent, rest stuck in warehouse. Remaining items may miss delivery window.',
    cpAlertUnprocessed: 'Unprocessed',
    cpAlertUnprocessedDesc: 'Imported 24h+ ago, not yet allocated. Assign inventory to start fulfillment.',
    // Status tabs
    cpStatusAll: 'All',
    cpStatusNeedsAction: 'Needs Action',
    cpStatusImported: 'Imported',
    cpStatusOnHold: 'On Hold',
    cpStatusAllocated: 'Allocated',
    cpStatusWarehouseProcessing: 'WH Processing',
    cpStatusShipped: 'Shipped',
    cpStatusDeallocated: 'Deallocated',
    cpStatusCancelled: 'Cancelled',
    cpStatusException: 'Exception',
    // Table headers
    cpColChannel: 'Channel',
    cpColOrderNo: 'Order #',
    cpColChannelOrderNo: 'Channel Order #',
    cpColCustomer: 'Customer',
    cpColShipTo: 'Ship To',
    cpColSkuQty: 'SKU / Qty',
    cpColAmount: 'Amount',
    cpColStatus: 'Status',
    cpColShipWindow: 'Ship Window',
    cpColShipments: 'Shipments',
    cpColPoNo: 'PO #',
    cpColShipBySla: 'Ship By / SLA',
    cpColFulfillment: 'Fulfillment',
    cpColSkuUnits: 'SKU / Units',
    cpColCreated: 'Created',
    cpColActions: 'Actions',
    cpColIssueNote: 'Issue / Note',
    cpColWarehouse: 'Warehouse',
    cpColShipFrom: 'Ship From',
    cpColShipDate: 'Ship Date',
    cpColUnits: 'Units',
    cpColPallets: 'Pallets',
    cpColTrackingDocs: 'Tracking / Docs',
    cpColLotSn: 'Lot / SN',
    cpColObOrderNo: 'OB Order #',
    // Expanded row
    cpDeliverBy: 'Deliver by:',
    cpShipped: 'Shipped:',
    cpUnitsLabel: 'units',
    cpNote: 'Note:',
    cpImportErrorLabel: 'Import Error:',
    cpNoOutboundOrders: 'No outbound orders created yet',
    cpFixAndRetryImport: 'Order has data issues — fix and retry import',
    cpRef: 'Ref:',
    cpVia: 'via',
    cpDcRcvd: 'DC rcvd',
    // Row actions
    cpFixRetry: 'Fix & Retry',
    cpResubmitAsn: 'Resubmit ASN',
    cpRelabelReship: 'Relabel & Reship',
    cpRetryAllocation: 'Retry Allocation',
    cpRelease: 'Release',
    cpRetryPush: 'Retry Push',
    cpShipNow: 'Ship Now',
    // Empty state
    cpNoOrdersFound: 'No orders found',
    // Status labels
    cpStatusImportedLabel: 'Imported',
    cpStatusOnHoldLabel: 'On Hold',
    cpStatusAllocatedLabel: 'Allocated',
    cpStatusDeallocatedLabel: 'Deallocated',
    cpStatusWarehouseProcessingLabel: 'Warehouse Processing',
    cpStatusShippedLabel: 'Shipped',
    cpStatusCancelledLabel: 'Cancelled',
    cpStatusExceptionLabel: 'Exception',
    // Alert bar
    cpIssues: 'issues',
    cpImmediateAction: 'Immediate Action',
    cpFollowUp: 'Follow Up',
    cpMonitor: 'Monitor',
    cpMore: 'more',
    // Misc
    cpOk: 'OK',
    ...
    cpPcs: 'pcs',
    // Shipment status labels
    cpShipmentPicking: 'Picking',
    cpShipmentPacked: 'Packed',
    cpShipmentShipped: 'Shipped',
    cpShipmentInTransit: 'In Transit',
    cpShipmentDcConfirmed: 'DC Confirmed',
    cpShipmentDcRejected: 'DC Rejected',
    // Tag labels
    cpTagOverdue: 'Overdue',
    cpTagSyncFail: 'Sync Fail',
    cpTagDcRejected: 'DC Rejected',
    cpTagDcShort: 'DC Short',
    cpTagUrgent: 'Urgent',
    cpTagSlaRisk: 'SLA Risk',
    cpTagWhStalled: 'WH Stalled',
    cpTagAllocFailed: 'Alloc Failed',
    cpTagPartialShip: 'Partial Ship',
    cpTagImportError: 'Import Error',
    // Mapping center
    mappingPageTitle: 'Mapping Center',
    mappingPageDescription: 'Manage fulfillment mappings from channel SKU to warehouse SKU around the OMS Product aggregate.',
    mappingHeaderCount: 'OMS Products',
    mappingCreate: 'Create Mapping',
    mappingCenterTitle: 'OMS Product Mappings',
    mappingCenterDescription: 'Each OMS Product can own many channel SKUs, but only one warehouse SKU mapping.',
    mappingSearchPlaceholder: 'Search OMS Product, channel SKU, warehouse SKU...',
    mappingFilterChannel: 'Channel',
    mappingFilterWarehouse: 'Warehouse',
    mappingSummaryTotal: 'OMS Products',
    mappingSummaryTotalDesc: 'Product-centered mapping aggregates in this prototype workspace.',
    mappingSummaryComplete: 'Complete',
    mappingSummaryCompleteDesc: 'Both channel and warehouse mappings are ready.',
    mappingSummaryPartial: 'Partial',
    mappingSummaryPartialDesc: 'One side is mapped and still needs completion.',
    mappingSummaryInvalid: 'Invalid',
    mappingSummaryInvalidDesc: 'Conflicts, duplicates, or required values are missing.',
    mappingStatusComplete: 'Complete',
    mappingStatusPartial: 'Partial',
    mappingStatusUnmapped: 'Unmapped',
    mappingStatusInvalid: 'Invalid',
    ...
    mappingTableUpdated: 'Updated',
    mappingTableChannelRows: 'channel rows',
    mappingEmptyTitle: 'No mappings found',
    mappingEmptyDescription: 'Adjust filters or create a new OMS Product mapping.',
    mappingDrawerTitle: 'OMS Product Mapping Detail',
    mappingDrawerDescription: 'Manage multiple channel SKUs and the single warehouse SKU in one detail panel.',
    mappingSectionProduct: 'OMS Product',
    mappingSectionProductDesc: 'Select the OMS product that owns these fulfillment bindings.',
    mappingSelectOmsProduct: 'Select OMS Product',
    mappingOmsProductCode: 'OMS Product Code',
    mappingOmsProductName: 'OMS Product Name',
    mappingSectionChannels: 'Channel Mappings',
    mappingSectionChannelsDesc: 'One OMS Product can keep multiple channel SKU bindings.',
    mappingAddChannel: 'Add Channel Mapping',
    mappingChannelsEmpty: 'No channel SKU mappings yet.',
    mappingChannelRow: 'Channel Mapping',
    mappingChannel: 'Channel',
    mappingStore: 'Store',
    mappingChannelSku: 'Channel SKU',
    mappingChannelEnabled: 'Enable this channel mapping',
    mappingChannelEnabledDesc: 'Disabled rows stay visible but are skipped by resolution.',
    mappingSectionWarehouse: 'Warehouse Mappings',
    mappingSectionWarehouseDesc: 'Each OMS Product can have multiple warehouse SKU mappings for different providers.',
    mappingSelectWarehouseTarget: 'Select warehouse SKU',
    mappingWarehouseEmpty: 'No warehouse mappings configured yet.',
    mappingWarehouseRow: 'Warehouse',
    mappingAddWarehouse: 'Add Warehouse Mapping',
    mappingWarehouse: 'Warehouse',
    mappingWarehouseSku: 'Warehouse SKU',
    mappingItemCode: 'Item Code',
    mappingItemMasterId: 'Item Master ID',
    mappingItemName: 'Item Name',
    mappingWarehouseEnabled: 'Enable warehouse mapping',
    mappingWarehouseEnabledDesc: 'Disabled mappings remain visible but are not used for fulfillment.',
    mappingChannelSkuHint: 'Type a SKU and press Enter or comma to add. Multiple SKUs supported.',
    mappingStoreSearch: 'Search store...',
    mappingStoreEmpty: 'No matching stores. Type to use a custom value.',
    mappingNotesDesc: 'Capture why this mapping exists or when it should be replaced.',
    mappingValidationTitle: 'Validation',
    mappingValidationNoIssues: 'No conflicts detected.',
    mappingSave: 'Save Mapping',
    mappingIssueProductCodeRequired: 'OMS Product Code is required.',
    mappingIssueProductNameRequired: 'OMS Product Name is required.',
    mappingIssueOmsProductAssigned: 'This OMS Product already has a mapping aggregate. Edit the existing record instead.',
    mappingIssueChannelRequired: 'Each channel mapping row must include channel, store, and at least one channel SKU.',
    mappingIssueDuplicateChannelInProduct: 'The same channel SKU cannot appear twice within one OMS Product.',
    mappingIssueChannelAssignedElsewhere: 'This channel SKU is already assigned to another OMS Product.',
    mappingIssueWarehouseRequired: 'If a warehouse mapping exists, warehouse and warehouse SKU are required.',
    mappingIssueDuplicateWarehouseInProduct: 'The same warehouse cannot appear more than once per OMS Product.',
    mappingImport: 'Batch Import',
    mappingImportTitle: 'Batch Import Mapping',
    mappingImportDescription: 'Upload a CSV file to bulk-create or update OMS Product Mappings.',
    mappingImportDownloadTemplate: 'Download CSV Template',
    mappingImportUpload: 'Upload CSV',
    mappingImportPreviewTitle: 'Import Preview',
    mappingImportPreviewRows: 'records',
    mappingImportConfirm: 'Confirm Import',
    mappingImportSuccess: 'Import successful',
    mappingImportErrorParse: 'Failed to parse file. Please check the format.',
    mappingImportColProduct: 'OMS Product Code',
    mappingImportColChannel: 'Channel',
    mappingImportColStore: 'Store',
    mappingImportColChannelSku: 'Channel SKU',
    mappingImportColWarehouse: 'Warehouse',
    mappingImportColWarehouseSku: 'Warehouse SKU',
    mappingHistoryTitle: 'Change History',
    mappingHistoryEmpty: 'No change history yet.',
    mappingHistoryActionCreated: 'Created',
    mappingHistoryActionUpdated: 'Updated',
    mappingHistoryBy: 'By',
    mappingAutoMatchTitle: 'Auto Mapping',
    mappingAutoMatchDescription: 'Automatically matches warehouse SKUs based on OMS Product name. Channel SKU mappings must be configured manually.',
    mappingAutoMatchRun: 'Run Auto Match',
    mappingAutoMatchApply: 'Apply {count} Matches',
    mappingAutoMatchNoResult: 'No warehouse SKUs found to auto-match.',
    mappingAutoMatchNewWarehouse: 'Warehouse targets to add',
    mappingAutoMatchAlreadyMapped: 'Already mapped, skipped',
    mappingAutoMatchSelectAll: 'Select all',
    mappingAutoMatchSuccess: 'Successfully applied {count} auto-match(es).',
  }
}
...
export function useI18n() {
  ...
  React.useEffect(() => {
    ...
    const nextLanguage = saved === 'zh' || saved === 'en' ? saved : 'zh'

    globalLanguage = nextLanguage
