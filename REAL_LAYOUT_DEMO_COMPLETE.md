...
### 批量操作功能 ⭐
当选中表格行时，会在筛选栏下方显示批量操作栏：

**批量操作栏样式**:
- 紫色边框 + 浅紫色背景 (`border-primary/20 bg-primary/5`)
- 显示选中数量: "已选择 X 项"
- 取消选择按钮

**批量操作按钮**:
1. **批量导出** - 导出选中的订单数据 (Success Toast)
2. **批量发送** - 向选中客户发送订单 (Success Toast)
3. **更多操作下拉菜单**:
   - 批量编辑 (Info Toast)
   - 批量打印 (Info Toast)
   - 批量归档 (Warning Toast)
   - 批量删除 (Error Toast - 带错误提示)

**Toast 通知系统**:
- ✅ Success (成功): 绿色左边框 + 浅绿背景
- ❌ Error (错误): 红色左边框 + 浅红背景
- ⚠️ Warning (警告): 黄色左边框 + 浅黄背景
- ℹ️ Info (信息): 灰色左边框 + 浅灰背景
- 位置: 页面顶部居中
- 自动适配明暗模式
...
---
**最后更新**: 2024-12-30 - 添加批量操作和 Toast 通知系统
